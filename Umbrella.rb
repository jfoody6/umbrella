...
personal_location = gets.chomp

#get personal location
puts "Checking for the weather outlook at #{personal_location}"

# Get the location from Google Maps API
gmaps_key = ENV.fetch("GMAPS_KEY")
gmaps_url = "https://maps.googleapis.com/maps/api/geocode/json?address=#{personal_location}&key=#{gmaps_key}"

#raw data stored
raw_gmaps = HTTP.get(gmaps_url)

#raw data into usable format
